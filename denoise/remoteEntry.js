define("denoise", [], () => { return /******/ (() => { // webpackBootstrap
/******/ 	"use strict";
...
var moduleMap = {
	"default": () => {
		return __webpack_require__.e(319).then(() => (() => ((__webpack_require__(319)))));
	}
};
...
/******/ 					var req = fetch(__webpack_require__.p + "" + {"381":{"746":"d2ddb820a0da07df86e2"}}[chunkId][wasmModuleId] + ".module.wasm");
/******/ 					var promise;
