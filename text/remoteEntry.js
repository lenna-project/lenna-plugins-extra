define("text", [], () => { return /******/ (() => { // webpackBootstrap
/******/ 	"use strict";
...
var moduleMap = {
	...
	"./Widget": () => {
		return Promise.all([__webpack_require__.e(748), __webpack_require__.e(593)]).then(() => (() => ((__webpack_require__(593)))));
	}
};
...
/******/ 					var req = fetch(__webpack_require__.p + "" + {"678":{"348":"2bc70b865415b82f9203"}}[chunkId][wasmModuleId] + ".module.wasm");
/******/ 					var promise;
